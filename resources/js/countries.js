...
// SELECT SEATCH COUNTRY ELEMENTS
...
function createCountryList(country_list) {
    const num_countries = country_list.length;

    let i = 0, ul_list_id, num_of_ul_lists = 3;
...
createCountryList(country_list);

change_country_btn.addEventListener('click', event => {
...
close_list_btn.addEventListener('click', event => {
    search_country_element.classList.add('hide');
    search_country_element.classList.add('fadeIn');
});

country_list_element.addEventListener('click', event => {
    search_country_element.classList.add('hide');
    search_country_element.classList.add('fadeIn');
});
